...
There is a total of 21,799 ECG signals, of which we utilized 21,388 with a diagnostic superclass mapping. 44% of ECGs were of normal superclass, 25% were MI, 13% were STTC, 11% were CD, and 7% were CD. The balanced split randomly chose 1500 for each class, with 1308 being used in total for CD. 
